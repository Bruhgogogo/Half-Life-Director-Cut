...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER(&sk_buckshot_bullet1);// {"sk_buckshot_bullet1","0"};
	CVAR_REGISTER(&sk_buckshot_bullet2);// {"sk_buckshot_bullet2","0"};
	CVAR_REGISTER(&sk_buckshot_bullet3);// {"sk_buckshot_bullet3","0"};

	CVAR_REGISTER(&sk_357_bullet1);// {"sk_357_bullet1","0"};
	CVAR_REGISTER(&sk_357_bullet2);// {"sk_357_bullet1","0"};
	CVAR_REGISTER(&sk_357_bullet3);// {"sk_357_bullet1","0"};
